...
$(".h2").after('<div class="js_div" />'); // création de la class js_div
    ...
    $(".js_div").append('<input class="Titre_input" type="texte"></input>');//Ajout du label titre du livre
    $(".js_div").append('<label class="label_auteur">Auteur</label>');//Ajout label auteur
    $(".js_div").append('<input class="Auteur_input" type="texte"></input>');//Ajout du label Auteur

    $(".js_div").append('<button class="btn_recherche">Rechercher</button>');//Ajout du bouton rechercher
    $(".js_div").append('<button class="btn_annuler">Annuler</button>');//Ajout du bouton annuler
    $(".js_div").append('<hr class="hr2">');//hr deux
...
// -------------------------------- function to clear result_div ---------------------------------------------------------------
function cleanBooks(){
	$(".result_div").empty();
}	
// -------------------------------- function to clear list_poche ---------------------------------------------------------------
